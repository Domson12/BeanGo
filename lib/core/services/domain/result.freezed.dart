...
mixin _$Result<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(APIErrors error) failure,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(APIErrors error)? failure,
...
abstract class Failure<T> implements Result<T> {
  const factory Failure(final APIErrors error) = _$FailureImpl<T>;
